...
<body class="bg-gradient-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url('Autentifikasi/registrasi') ?>">Belum Punya Akun?</a><br>
                                        <a class="small" href="<?= base_url('Landing') ?>">Kembali ke Beranda</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="<?= base_url() ?>assets/frontend/js/sb-admin-2.min.js"></script>
